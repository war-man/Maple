...
namespace Maple.Test
{
    ...
    public class EnsuringEqualTests
    {
        ...
        public void When_comparing_different_strings()
        {
            ...
            action.ShouldThrow<ArgumentException>("Because the two strings are different").Message.ShouldBe(Resources.ExceptionMessageEqualValues);
        }
        ...
        public void When_comparing_different_integers()
        {
            ...
            action.ShouldThrow<ArgumentException>("Because the two integers are different").Message.ShouldBe(Resources.ExceptionMessageEqualValues);
        }
        ...
        public void When_comparing_string_against_null_object()
        {
            ...
            action.ShouldThrow<ArgumentException>("Because the objects are different").Message.ShouldBe(Resources.ExceptionMessageEqualValues);
        }
