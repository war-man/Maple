...
namespace Maple.Core
{
    ...
    public static class Ensure
    {
        ...
        {
            if (string.IsNullOrEmpty(message))
                message = Resources.ExceptionMessageTrueCondition;
        ...
        public static DirectoryInfo Exists(DirectoryInfo directoryInfo)
        {
            ...
            That<DirectoryNotFoundException>(directoryInfo.Exists, Resources.ExceptionMessageMissingDirectory + directoryInfo.FullName);
        ...
        public static FileInfo Exists(FileInfo fileInfo)
        {
            ...
            fileInfo.Refresh();
            That<FileNotFoundException>(fileInfo.Exists, Resources.ExceptionMessageMissingFile + fileInfo.FullName);
            return fileInfo;
        }
    }
}
